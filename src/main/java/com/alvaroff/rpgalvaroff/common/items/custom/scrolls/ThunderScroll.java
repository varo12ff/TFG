...
import com.alvaroff.rpgalvaroff.capabilities.playerSkills.ThunderSkill;
...
public class ThunderScroll extends Item {
    public ThunderScroll(Properties p_41383_) {
        super(p_41383_);
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand){
        ...
        if(!world.isClientSide()){
            ...
            if(!PlayerUtils.isSkillLearned(skills, thunder.getId())) {
                player.getCapability(PlayerStatsProvider.PLAYER_STATS).orElse(new PlayerStats()).addTotalSkills(thunder.getId());
                itemStack.shrink(1);
            }
            else

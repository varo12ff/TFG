...
public class MagicSword extends SwordItem {
    public MagicSword(Tier p_43269_, int p_43270_, float p_43271_, Properties p_43272_) {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(new TextComponent("Nivel mínimo de Poder Mágico: 5").withStyle(ChatFormatting.GRAY));
        tooltip.add(new TextComponent("Escalado por Poder Mágico S").withStyle(ChatFormatting.DARK_PURPLE));
    }
}

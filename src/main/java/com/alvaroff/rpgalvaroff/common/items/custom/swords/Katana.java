...
public class Katana extends SwordItem {
    ...
    public void appendHoverText(ItemStack stack, @Nullable Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add(new TextComponent("Nivel mínimo de habilidad: 5").withStyle(ChatFormatting.GRAY));
        tooltip.add(new TextComponent("Escalado por habilidad S").withStyle(ChatFormatting.DARK_PURPLE));
    }
}
